...
export function settings(input) {
 ...
 return {format:input.format,maxEntries,deadlineMode:'per-game',tiebreaker:input.format==='pickem'?input.tiebreaker:'shared',tiesLose:input.format==='survivor' ? input.tiesLose!==false : true};
}
